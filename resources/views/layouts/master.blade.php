...
<link rel="stylesheet" href="http://www.southernnewengland.aaa.com/uploads/club1/media/insider/font/test-ps/style-ps.css">
...
<script type="text/javascript" src="club1/media/insider/font/test-ps/jquery.main-ps.js"></script>
			...
			<nav id="nav" class="stickyme">
				<div class="nav-inner">
					<ul>
						...
						<li><a href="http://www.pstr.club/page/event-schedule.php">Event Schedules</a></li>
